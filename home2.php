...
{ 
    ...
    // Récupérer le nombre de votes de l'utilisateur
    $userVoteCount = $message->getUserVoteCount($id);
    if (isset($_POST["save"]))
    {
...
<body>
    <div class="phppot-container" style="margin-top: 30px;">
        ...
        <div class="page-content">  
            ...
            <p><strong>Nombre de messages votés :</strong> <?php echo $userVoteCount; ?></p>
        </div>
    </div>  
            ...
            <div class="col-md-8">
                <div class="card text-center mt-2">
                    <div class="card-body">
                        ...
                        if (!empty($m[0])) { 
                        ?>
                            <p class="card-text fst-italic" style="font-size: 18px;"><?php echo htmlspecialchars($m[0]["text"]); ?></p>
                        <?php } else { ?>
                        ...
                        <form action="" method="POST" onsubmit="return VoteValidation()">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label" for="exampleRadios1">Haineux</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="vote" id="exampleRadios2" value="0">
                                    <label class="form-check-label" for="exampleRadios2">Non Haineux</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="vote" id="exampleRadios3" value="2">
                                    <label class="form-check-label" for="exampleRadios3">Je ne sais pas</label>
                                </div>
                            </div>
                            <div class="form-group" style="margin-top: 25px;">
                                <div class="form-label fst-italic font-weight-bold" style="text-align: center;">
                                    *Expliquez le choix (Entrez juste les mots clés ou entrez "RAS" si vous n'avez pas d'explication) :<br/>
                                    <span class="required error fst-italic" id="text_expli" style="font-size: 11px;"></span>
                                </div>
